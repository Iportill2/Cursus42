...
/*   Updated: 2023/10/20 13:32:27 by jgoikoet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	while (g_data->array_input[i])
	{
		...
		while(g_data->array_input[i][j])
		{
			if (g_data->array_input[i][j] == '"' || g_data->array_input[i][j] == '\'')
			{
				...
				else if (d == g_data->array_input[i][j])
				{
					d = 'x';
					j++;
				}
			 ...
			 else if (g_data->array_input[i][j] && g_data->array_input[i][j] == '$' && d != '\'')
			{
